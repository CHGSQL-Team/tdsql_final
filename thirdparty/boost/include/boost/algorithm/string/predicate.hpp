...
//  starts_with predicate  -----------------------------------------------//
        ...
        */
        ...
        inline bool starts_with(
                ...
                const Range2T &Test,
                PredicateT Comp) {
            iterator_range<BOOST_STRING_TYPENAME range_const_iterator<Range1T>::type> lit_input(
                    ::boost::as_literal(Input));
            iterator_range<BOOST_STRING_TYPENAME range_const_iterator<Range2T>::type> lit_test(
                    ::boost::as_literal(Test));
...
//  contains predicate  -----------------------------------------------//
        ...
        */
        ...
        inline bool contains(
            ...
            bool bResult = (::boost::algorithm::first_finder(lit_test, Comp)(::boost::begin(lit_input),
                                                                             ::boost::end(lit_input)));
            return bResult;
        }
...
// lexicographical_compare predicate -----------------------------//
        ...
        inline bool lexicographical_compare(
                ...
                const Range2T &Arg2,
                PredicateT Pred) {
            iterator_range<BOOST_STRING_TYPENAME range_const_iterator<Range1T>::type> lit_arg1(
                    ::boost::as_literal(Arg1));
            iterator_range<BOOST_STRING_TYPENAME range_const_iterator<Range2T>::type> lit_arg2(
                    ::boost::as_literal(Arg2));
...
//  all predicate  -----------------------------------------------//
        ...
        */
        ...
        inline bool all(
                const RangeT &Input,
                PredicateT Pred) {
            iterator_range<BOOST_STRING_TYPENAME range_const_iterator<RangeT>::type> lit_input(
                    ::boost::as_literal(Input));
