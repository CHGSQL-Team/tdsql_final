    ...
    namespace accumulators {
        ...
        namespace detail {
            ...
            struct is_accumulator_set
                    : mpl::if_<
                            boost::is_base_of<
                                    accumulator_set_base, typename boost::remove_const<
        ...
        struct accumulator_set
            ...
            accumulator_set()
                    ...
                    detail::make_acc_list(
                            accumulators_mpl_vector(), (boost::accumulators::accumulator = *this)
                    )
            ) {
            ...
            explicit accumulator_set(
                    A1 const &a1, typename boost::enable_if<
                    parameter::is_argument_pack<A1>, detail::_enabler
            >::type = detail::_enabler()
            ) : accumulators(
                    detail::make_acc_list(
                            accumulators_mpl_vector(), (boost::accumulators::accumulator = *this, a1)
                    )
            ) {
                // Add-ref the Features that the user has specified
                this->template visit_if<detail::contains_feature_of_<Features> >(
            ...
            template<typename A1>
            explicit accumulator_set(
                    A1 const &a1, typename boost::disable_if<
                    parameter::is_argument_pack<A1>, detail::_enabler
            >::type = detail::_enabler()
            ) : accumulators(
                    detail::make_acc_list(
...
#define BOOST_ACCUMULATORS_ACCUMULATOR_SET_FUN_OP(z, n, _)                              \
    ...
    {                                                                                   \
        this->visit(                                                                    \
            ...
            ///
            BOOST_PP_REPEAT_FROM_TO (
                    1, BOOST_PP_INC(BOOST_ACCUMULATORS_MAX_ARGS), BOOST_ACCUMULATORS_ACCUMULATOR_SET_FUN_OP, _
            )
            ...
            struct apply
                    : fusion::result_of::value_of<
                            typename fusion::result_of::find_if<
                                    accumulators_type, detail::matches_feature<Feature>
                            >::type
                    > {
            };
...
#define BOOST_ACCUMULATORS_EXTRACT_RESULT_FUN(z, n, _)                      \
    ...
    {                                                                       \
        ...
        BOOST_PP_REPEAT_FROM_TO (
                1, BOOST_PP_INC(BOOST_ACCUMULATORS_MAX_ARGS), BOOST_ACCUMULATORS_EXTRACT_RESULT_FUN, _
        )
