        ...
        namespace impl {
            ...
            */
            ...
            struct weighted_extended_p_square_impl
                ...
                ), heights(2 * probabilities.size() + 3), actual_positions(heights.size()),
                ...
                void operator()(Args const &args) {
                    ...
                    if (cnt <= num_markers) {
                        ...
                        // compute desired positions
                        {
                            ...
                            this->desired_positions[1] =
                                    (sum_of_weights(args) - this->actual_positions[0]) * probabilities[0]
                                    / 2. + this->actual_positions[0];
                            this->desired_positions[num_markers - 2] =
                                    (sum_of_weights(args) - this->actual_positions[0])
...
//
        namespace tag {
            struct weighted_extended_p_square
                    : depends_on<count, sum_of_weights>, extended_p_square_probabilities {
