            ...
            struct weighted_peaks_over_threshold_impl
                ...
                weighted_peaks_over_threshold_impl(Args const &args)
                        : sign_((is_same<LeftRight, left>::value) ? -1 : 1),
                          ...
                          threshold_(sign_ * args[pot_threshold_value]), fit_parameters_(boost::make_tuple(0., 0., 0.)),
                          is_dirty_(true) {
                }
                ...
                result_type result(Args const &args) const {
                    if (this->is_dirty_) {
                        ...
                        float_type threshold_probability = numeric::fdiv(sum_of_weights(args) - this->w_sum_,
                                                                         sum_of_weights(args));

                        float_type tmp = numeric::fdiv((this->mu_ - this->threshold_) * (this->mu_ - this->threshold_),
                                                       this->sigma2_);
                        ...
                        float_type u_bar = this->threshold_ -
                                           beta_bar * (std::pow(1. - threshold_probability, -xi_hat) - 1.) / xi_hat;
            ...
            struct weighted_peaks_over_threshold_prob_impl
                ...
                weighted_peaks_over_threshold_prob_impl(Args const &args)
                        : sign_((is_same<LeftRight, left>::value) ? -1 : 1),
                          ...
                          fit_parameters_(boost::make_tuple(0., 0., 0.)), is_dirty_(true) {
                }
                ...
                result_type result(Args const &args) const {
                    if (this->is_dirty_) {
                        ...
                        float_type threshold = sum_of_weights(args)
                                               *
                                               ((is_same<LeftRight, left>::value) ? this->threshold_probability_ : 1. -
                        ...
                        while (sum < threshold) {
                            if (n < static_cast<std::size_t>(tail_weights(args).size())) {
                                ...
                                sigma2_ += *(tail_weights(args).begin() + n) * *(tail(args).begin() + n) *
                                           (*(tail(args).begin() + n));
                        ...
                        float_type u_bar =
                                u - beta_bar * (std::pow(1. - threshold_probability_, -xi_hat) - 1.) / xi_hat;
                        this->fit_parameters_ = boost::make_tuple(u_bar, beta_bar, xi_hat);
...
//
        namespace tag {
            ...
            struct weighted_peaks_over_threshold
                    : depends_on<sum_of_weights>, pot_threshold_value {
                /// INTERNAL ONLY
            ...
            struct weighted_peaks_over_threshold_prob
                    : depends_on<sum_of_weights, tail_weights<LeftRight> >, pot_threshold_probability {
                /// INTERNAL ONLY
