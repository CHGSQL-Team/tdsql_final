            ...
            */
            ...
            struct peaks_over_threshold_impl
                ...
                peaks_over_threshold_impl(Args const &args)
                        : Nu_(0), mu_(sign::value * numeric::fdiv(args[sample | Sample()], (std::size_t) 1)),
                ...
                result_type result(Args const &args) const {
                    if (this->is_dirty_) {
                        ...
                        std::size_t n = static_cast<std::size_t>(
                                std::ceil(
                                        cnt * ((is_same<LeftRight, left>::value) ? this->threshold_probability_ : 1. -
...
//
        namespace tag {
            ...
            struct peaks_over_threshold
                    : depends_on<count>, pot_threshold_value {
                /// INTERNAL ONLY
                ///
            ...
            struct peaks_over_threshold_prob
                    : depends_on<count, tail<LeftRight> >, pot_threshold_probability {
                /// INTERNAL ONLY
                ///
