            ...
            struct density_impl
                ...
                void operator()(Args const &args) {
                    ...
                    if (cnt == this->cache_size) {
                        ...
                        for (typename array_type::const_iterator iter = this->cache.begin();
                    ...
                    if (this->is_dirty) {
                        ...
                        for (std::size_t i = 0; i < this->num_bins + 2; ++i) {
                            this->histogram[i] = std::make_pair(this->bin_positions[i],
                                                                numeric::fdiv(this->samples_in_bin[i], count(args)));
                        }
                    }
...
//
        namespace tag {
            struct density
                    : depends_on<count, min, max>, density_cache_size, density_num_bins {
                /// INTERNAL ONLY
                ///
