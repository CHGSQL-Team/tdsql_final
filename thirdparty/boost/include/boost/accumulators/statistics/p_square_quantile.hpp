            ...
            */
            ...
            struct p_square_quantile_impl
                ...
                p_square_quantile_impl(Args const &args)
                        : p(is_same<Impl, for_median>::value ? float_type(0.5) : args[quantile_probability |
                                                                                      float_type(0.5)]), heights(),
                          actual_positions(), desired_positions(), positions_increments() {
                ...
                void operator()(Args const &args) {
                    ...
                    if (cnt <= 5) {
                        ...
                        for (std::size_t i = 1; i <= 3; ++i) {
                            ...
                            if ((d >= float_type(1.) && dp > float_type(1.)) ||
                                (d <= float_type(-1.) && dm < float_type(-1.))) {
